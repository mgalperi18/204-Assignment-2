...
public class NotationQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(m, doubleQ.dequeue());
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(i));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(r));
	...
	public void testToStringStudent() throws QueueOverflowException {
		//Use the doubleQ for student tests
		//fail("Not yet implemented");
		assertEquals("7.08.09.0", doubleQ.toString());
		doubleQ.enqueue(r);
		assertEquals("7.08.09.09.0", doubleQ.toString());
		doubleQ.enqueue(i);
		assertEquals("7.08.09.09.08.0", doubleQ.toString());
	}
