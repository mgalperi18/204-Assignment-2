...
public class NotationStackTest {
	...
	public Double m = 7.0, i = 8.0 , r = 9.0;
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(r, doubleS.pop());
			assertEquals(i, doubleS.pop());
			assertEquals(m, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(i));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(r));
	...
	public void testToStringStudent() throws StackOverflowException {
		//Use the doubleQ for student tests
		//fail("Not yet implemented");
		assertEquals("7.08.09.0", doubleS.toString());
		doubleS.push(r);
		assertEquals("7.08.09.09.0", doubleS.toString());
		doubleS.push(i);
		assertEquals("7.08.09.09.08.0", doubleS.toString());
	}
